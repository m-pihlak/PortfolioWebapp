<template>
  <div id="app">
    ...
    <div class="content_align" style="margin: var(--spacing);">
      <BioCard style="z-index: 10;"></BioCard>
      <ContentBlock style="z-index: 10;"></ContentBlock>
    </div>
  </div>
</template>
